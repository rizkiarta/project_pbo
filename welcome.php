...
<body>
    ...
    <div class="fixed-top bg-white shadow-sm py-4" style="z-index: 10;">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <a href="welcome.php" class="text-decoration-none">
                    <h1 class="text-primary mb-0 fw-bold">DariKebun</h1>
                </a>
                
                <div class="d-flex align-items-center">
                    <?php if(!isLoggedIn()): ?>
                        <a href="login.php" class="btn btn-primary border-primary rounded-pill py-2 px-4 me-2">Masuk</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <?php if(!isLoggedIn()): ?>
                        <a href="register.php" class="btn btn-primary border-primary rounded-pill py-3 px-5 animated slideInDown">Ayo Berbelanja</a>
                    <?php else: ?>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="py-4 text-center">
                        ...
                        <a href="index.php" class="btn btn-primary border-primary rounded-pill py-3 px-5">Belanja Sekarang</a>
                    </div>
                </div>
                <div class="col-lg-6">

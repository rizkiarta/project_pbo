...
// require_once 'head.php'; // Opsional: Matikan ini jika head.php sudah dipanggil di file induk (index.php, shop.php, dll) agar tidak double
?>
        ...
        <nav class="navbar navbar-light bg-white navbar-expand-xl px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    <a href="index.php" class="nav-item nav-link <?php echo ($current_page == 'home') ? 'active' : ''; ?>">Beranda</a>
                    <a href="shop.php" class="nav-item nav-link <?php echo ($current_page == 'shop') ? 'active' : ''; ?>">Toko</a>
                    <a href="orders.php" class="nav-item nav-link <?php echo ($current_page == 'orders') ? 'active' : ''; ?>">Pesanan</a>
                    <a href="contact.php" class="nav-item nav-link <?php echo ($current_page == 'contact') ? 'active' : ''; ?>">Kontak</a>
                </div>
